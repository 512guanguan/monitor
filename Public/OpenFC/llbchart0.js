...
function drawline(i){
	...
	"9.0.0",
	"expressInstall.swf",
	{"get-data":"open_flash_chart_data"},{},{id:"chart"});//默认函数
	alert("drawline(0)");
}
//"get-data":"open_flash_chart_data"
//"data-file":"Application/OFC/data4.php"这种方法可行，优先级低于ofc=data4.php
function ofc_ready()
{
    alert('ofc_ready');
...
function open_flash_chart_data() {//默认没提供数据就会调用这个函数的
...
function reloadData(i){
	if(i==null){
		i=document.getElementById("page").value;
	} 
	if(i==0){
		url="Application/OFC/data4.php"
	}else{
